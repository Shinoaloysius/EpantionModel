package com.example.epantionmodel;
...
import static com.example.epantionmodel.Utils.dpToPx;
...
public class ExpansionPanelSampleActivityProgrammatically extends AppCompatActivity {
    ...
    private ExpansionLayout createExpansionLayout() {
        ...
        expansionLayout.addView(layout, ViewGroup.LayoutParams.MATCH_PARENT, dpToPx(this, 100)); //equivalent to addView(linearLayout)

//        final TextView text = new TextView(this);
//        text.setText("Content");
//        text.setGravity(Gravity.CENTER);
//        text.setTextColor(Color.parseColor("#3E3E3E"));
//        text.setBackgroundColor(Color.parseColor("#FF4081"));
//        layout.addView(text, ViewGroup.LayoutParams.MATCH_PARENT, dpToPx(this, 100));
//
//
